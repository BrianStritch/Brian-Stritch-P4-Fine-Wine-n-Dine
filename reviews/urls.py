...
urlpatterns = [    
    ...
    path('reviews/edit_review/<int:pk>/', views.EditReview.as_view(), name='edit_review'), 
    path('reviews/delete_review/<int:pk>/', views.DeleteReview.as_view(), name='delete_review'), 
    path('reviews/edit_comment/<int:pk>/', views.EditComment.as_view(), name='edit_comment'), 
    path('reviews/delete_comment/<int:pk>/', views.DeleteComment.as_view(), name='delete_comment'), 
]